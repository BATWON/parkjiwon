...
//	   // 배치 
	   setLayout(null);
	   posterLa.setBounds(270, 15, 700, 350);
...
//	   menu.setBounds(365, 295, 400, 35);
	   name.setBounds(270, 370, 400, 35);
	   address.setBounds(270, 410, 400, 35);
	   tel.setBounds(270, 450, 400, 35);
	   type.setBounds(270, 490, 400, 35);
	   price.setBounds(270, 530, 400, 35);
	   parking.setBounds(270, 570, 400, 35);
	   time.setBounds(270, 610, 400, 35);
	   menu.setBounds(270, 650, 400, 35);
//	   movie.setVisible(false);
	   JPanel p=new JPanel();
	   p.add(b1);
	   p.setBounds(270, 690, 400, 35);
//	   
